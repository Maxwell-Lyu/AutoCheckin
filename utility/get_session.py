...
# prompt for data
api_id = input('Your telegram api_id, achieved from https://core.telegram.org/api/obtaining_api_id:\n')
api_hash = input('Your telegram api_hash, achieved from https://core.telegram.org/api/obtaining_api_id:\n')
